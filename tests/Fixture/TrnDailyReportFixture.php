...
/**
 * TrnDailyReportFixture
 *
 */
class TrnDailyReportFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['daily_id', 'report_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
