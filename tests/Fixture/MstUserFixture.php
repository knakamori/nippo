 ...
 *
 */
class MstUserFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rank_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '3', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'group_id' => 1,
                'rank_id' => 1,
                'create_date' => '2019-02-22 07:37:29',
                'update_date' => '2019-02-22 07:37:29'
            ],
        ];
        parent::init();
    }
